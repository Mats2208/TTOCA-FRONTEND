      ...
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <button
            ...
            className="bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-2.5 rounded-full font-medium hover:shadow-md hover:from-red-700 hover:to-red-800 transition-all duration-300 ease-in-out flex items-center space-x-2"
          >
      ...
      >
        <div className="container mx-auto px-6 py-4 space-y-5">
          ...
          <button
            ...
            className="w-full text-center bg-gradient-to-r from-red-600 to-red-700 text-white py-3 rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 font-medium flex justify-center items-center space-x-2"
          >
            <LogOut className="w-5 h-5" />
            <span>Cerrar sesión</span>
          </button>
